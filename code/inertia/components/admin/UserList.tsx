...
const UserList = () => {
  ...
  const { usersCount } = usePage<InferPageProps<AdminController, 'showDashboard'>>().props
  ...
  return (
    <div className="relative bg-gradient-to-br h-full from-slate-800/80 via-indigo-900/10 to-slate-800/80 border border-indigo-400/30 rounded-lg p-4 backdrop-blur-md shadow-lg transition-all duration-300 hover:border-indigo-400/50 grid grid-rows-[auto_1fr_auto]">
      ...
      <div className="space-y-4 overflow-y-auto pr-1 overflow-x-hidden gap-7">
