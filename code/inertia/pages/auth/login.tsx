      ...
      <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative z-1 text-fuchsia-200/80">
          <div className="flex flex-col gap-5">
            ...
            <p>Not a member ? <a href="/register" className="underline text-cyan-500">Register</a></p>
          </div>
          <form action="" className="flex flex-col gap-4 max-w-md mt-8">
            ...
            <div className="relative mb-1">
              ...
              <div className="flex justify-end mt-1">
                <a href="/forgot-password" className="text-xs text-gray-400 hover:text-violet-400">Forgot Password?</a>
              </div>
            </div>
            ...
            <button 
              type="submit" 
              className="bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white py-3 rounded-lg font-semibold mt-6"
            >
              Login
            </button>
          </form> 
